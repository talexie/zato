...
$(document).ready(function() {
    ...
    $.fn.zato.data_table.setup_forms(['name', 'def_id', 'queue', 'consumer_tag_prefix', 'pool_size', 'service', 'prefetch_count','queue_priority']);
})
...
$.fn.zato.channel.amqp.data_table.new_row = function(item, data, include_tr) {
    ...
    row += String.format('<td>{0}</td>', item.max_priority);
